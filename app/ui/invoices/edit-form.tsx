...
import { CustomerField, InvoiceForm, InvoiceStatusType } from "@/app/lib/definitions";
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
export default function EditInvoiceForm({
  ...
  const updateInvoiceWithId = updateInvoice.bind(null, invoice.id, userId as string);
  ...
  const handleStatusChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setStatus(event.target.value as InvoiceStatusType);
  };
